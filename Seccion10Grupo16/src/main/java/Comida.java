...
public class Comida {
    ...
    public Comida(String nombre, String tipo, List<String> ingredientes, List<String> ingredientesExcluidos) {
        this.nombre = nombre;
        this.tipo = tipo;
 ...
 // Setter and getter for the 'nombre' attribute
    ...
    // Setter and getter for the 'ingredientesExcluidos' attribute
